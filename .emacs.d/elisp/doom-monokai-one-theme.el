;; doom-monokai-one-theme.el --- inspired by Textmate's Monokai -*- lexical-binding: t; no-byte-compile: t; -*-
;; based on doom-monokai-classic-theme with some colors from doom-one-theme
(require 'doom-themes)
...
(defcustom doom-monokai-one-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-monokai-one-theme
  :type 'boolean)

(defcustom doom-monokai-one-comment-bg doom-monokai-one-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-monokai-one-theme
  :type 'boolean)

(defcustom doom-monokai-one-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-monokai-one
  "A dark, vibrant theme inspired by Textmate's Monokai with some doom-one colors."
  ...
  ((bg         '("#282c34" "black"   "black"      )) ; one theme color
   ...
   (fg         '("#d9dde0" "#bfbfbf" "brightwhite")) ; bit brighter than one theme, darker than monokai
   (fg-alt     '("#58616d" "#2d2d2d" "white"      )) ; bit brighter than one theme, darker than monokai
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if doom-monokai-one-brighter-comments violet base5))
   (doc-comments   (if doom-monokai-one-brighter-comments (doom-lighten violet 0.1) (doom-lighten base5 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       magenta)
   (methods        green)
   ...
   (-modeline-pad
    (when doom-monokai-one-padded-modeline
      (if (integerp doom-monokai-one-padded-modeline) doom-monokai-one-padded-modeline 4)))
  ...
  ((cursor :background magenta)
   ...
   ;;;; ace-window leading char face
   (aw-leading-char-face :foreground red :background base2 :italic nil))

  ;;;; Base theme variable overrides
  ;; ()
  )

;;; doom-monokai-one-theme.el ends here
